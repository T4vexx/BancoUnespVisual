    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        login.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                if(numeroDaAgencia.getText() != "" && numeroDaConta.getText() != "" && senha.getText() != "") {
                    isCredentialsCorrect = displayBanco.login(actionEvent,numeroDaAgencia.getText(),numeroDaConta.getText(),senha.getText());
